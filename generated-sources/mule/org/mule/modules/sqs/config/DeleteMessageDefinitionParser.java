...
import org.mule.modules.sqs.processors.DeleteMessageMessageProcessor;
    ...
    extends AbstractDevkitBasedDefinitionParser
{
    ...
    private BeanDefinitionBuilder getBeanDefinitionBuilder(ParserContext parserContext) {
        try {
            ...
            logger.error(("Cannot launch the mule app, the @Processor [delete-message] within the connector [sqs] is not supported in mule "+ muleVersion));
            throw new BeanDefinitionParsingException(new Problem(("Cannot launch the mule app, the @Processor [delete-message] within the connector [sqs] is not supported in mule "+ muleVersion), new Location(parserContext.getReaderContext().getResource()), null, noClassDefFoundError));
        }
    }
    ...
    public BeanDefinition parse(Element element, ParserContext parserContext) {
        ...
        parseProperty(builder, element, "receiptHandle", "receiptHandle");
